      ...
      export module supabase {
        export module auth {
          export class CodeVerifierCache {
             ...
             */
            public constructor(implementation: { saveCodeVerifier(param0: string, param1: any): any; loadCodeVerifier(param0: any): any; deleteCodeVerifier(param0: any): any });
            public constructor();
      ...
      export module supabase {
        export module auth {
          export class OtpType {
             ...
             */
            public constructor(implementation: { getType(): string });
            public constructor();
      ...
      export module supabase {
        export module auth {
          export class SessionManager {
             ...
             */
            public constructor(implementation: { saveSession(param0: io.github.jan.supabase.auth.user.UserSession, param1: any): any; loadSession(param0: any): any; deleteSession(param0: any): any });
            public constructor();
            public saveSession(param0: io.github.jan.supabase.auth.user.UserSession, param1: any): any;
            public deleteSession(param0: any): any;
            public loadSession(param0: any): any;
        ...
        export module auth {
          export module admin {
            export class LinkType<C> extends java.lang.Object {
               ...
               */
              public constructor(implementation: { getType(): string; createConfig(param0: any): C });
              public constructor();
              public getType(): string;
        ...
        export module auth {
          export module providers {
            export class AuthProvider<C, R> extends java.lang.Object {
               ...
               */
              public constructor(implementation: { login(param0: io.github.jan.supabase.SupabaseClient, param1: any, param2: string, param3: any, param4: any): any; signUp(param0: io.github.jan.supabase.SupabaseClient, param1: any, param2: string, param3: any, param4: any): any });
              public constructor();
              public signUp(param0: io.github.jan.supabase.SupabaseClient, param1: any, param2: string, param3: any, param4: any): any;
              public login(param0: io.github.jan.supabase.SupabaseClient, param1: any, param2: string, param3: any, param4: any): any;
            }
          ...
          export module providers {
            export module builtin {
              export class DefaultAuthProvider<C, R> extends io.github.jan.supabase.auth.providers.AuthProvider<any, any> {
                 ...
                 */
                public constructor(implementation: { getGrantType(): string; login(param0: io.github.jan.supabase.SupabaseClient, param1: any, param2: string, param3: any, param4: any): any; signUp(param0: io.github.jan.supabase.SupabaseClient, param1: any, param2: string, param3: any, param4: any): any; decodeResult(param0: kotlinx.serialization.json.JsonObject): any; encodeCredentials(param0: any): kotlinx.serialization.json.JsonObject; login(param0: io.github.jan.supabase.SupabaseClient, param1: any, param2: string, param3: any, param4: any): any; signUp(param0: io.github.jan.supabase.SupabaseClient, param1: any, param2: string, param3: any, param4: any): any });
                public constructor();
        ...
        export module auth {
          export module user {
            export class UserInfo {
              ...
              public copy(
                appMetadata: kotlinx.serialization.json.JsonObject,
                aud: string,
                confirmationSentAt: kotlinx.datetime.Instant,
                confirmedAt: kotlinx.datetime.Instant,
                createdAt: kotlinx.datetime.Instant,
                email: string,
                emailConfirmedAt: kotlinx.datetime.Instant,
                factors: java.util.List<io.github.jan.supabase.auth.user.UserMfaFactor>,
                id: string,
                identities: java.util.List<io.github.jan.supabase.auth.user.Identity>,
                lastSignInAt: kotlinx.datetime.Instant,
                phone: string,
                role: string,
                updatedAt: kotlinx.datetime.Instant,
                userMetadata: kotlinx.serialization.json.JsonObject,
                phoneChangeSentAt: kotlinx.datetime.Instant,
                newPhone: string,
                emailChangeSentAt: kotlinx.datetime.Instant,
                newEmail: string,
                invitedAt: kotlinx.datetime.Instant,
                recoverySentAt: kotlinx.datetime.Instant,
                phoneConfirmedAt: kotlinx.datetime.Instant,
                actionLink: string
              ): io.github.jan.supabase.auth.user.UserInfo;
      ...
      export module supabase {
        export module postgrest {
          export class Postgrest extends java.lang.Object {
             ...
             */
            public constructor(implementation: { from(param0: string): io.github.jan.supabase.postgrest.query.PostgrestQueryBuilder; from(param0: string, param1: string): io.github.jan.supabase.postgrest.query.PostgrestQueryBuilder; get(param0: string, param1: string): io.github.jan.supabase.postgrest.query.PostgrestQueryBuilder; get(param0: string): io.github.jan.supabase.postgrest.query.PostgrestQueryBuilder; rpc(param0: string, param1: any, param2: any): any; rpc(param0: string, param1: kotlinx.serialization.json.JsonObject, param2: any, param3: any): any; '<clinit>'(): void });
            public constructor();
            public static API_VERSION: number = 1;
      ...
      export module supabase {
        export module postgrest {
          export class PropertyConversionMethod {
             ...
             */
            public constructor(implementation: { invoke(param0: any): string; '<clinit>'(): void });
            public constructor();
        ...
        export module postgrest {
          export module executor {
            export class RequestExecutor {
               ...
               */
              public constructor(implementation: { execute(param0: io.github.jan.supabase.postgrest.Postgrest, param1: string, param2: io.github.jan.supabase.postgrest.request.PostgrestRequest, param3: any): any });
              public constructor();
        ...
        export module postgrest {
          export module request {
            export class PostgrestRequest {
               ...
               */
              public constructor(implementation: { getBody(): kotlinx.serialization.json.JsonElement; getMethod(): io.ktor.http.HttpMethod; getUrlParams(): java.util.Map<string, string>; getHeaders(): io.ktor.http.Headers; getReturning(): io.github.jan.supabase.postgrest.query.Returning; getPrefer(): java.util.List<string>; getSchema(): string });
              public constructor();
              public getHeaders(): io.ktor.http.Headers;
              public getMethod(): io.ktor.http.HttpMethod;
              public getReturning(): io.github.jan.supabase.postgrest.query.Returning;
      ...
      export module supabase {
        export module realtime {
          export class CallbackManager {
             ...
             */
            public constructor(implementation: { triggerPostgresChange(param0: java.util.List<java.lang.Long>, param1: io.github.jan.supabase.realtime.PostgresAction): void; triggerBroadcast(param0: string, param1: kotlinx.serialization.json.JsonObject): void; triggerPresenceDiff(param0: java.util.Map<string, io.github.jan.supabase.realtime.Presence>, param1: java.util.Map<string, io.github.jan.supabase.realtime.Presence>): void; addBroadcastCallback(param0: string, param1: any): number; addPostgresCallback(param0: io.github.jan.supabase.realtime.PostgresJoinConfig, param1: any): number; addPresenceCallback(param0: any): number; removeCallbackById(param0: number): void; setServerChanges(param0: java.util.List<io.github.jan.supabase.realtime.PostgresJoinConfig>): void });
            public constructor();
      ...
      export module supabase {
        export module realtime {
          export class HasOldRecord {
             ...
             */
            public constructor(implementation: { getOldRecord(): kotlinx.serialization.json.JsonObject });
            public constructor();
      ...
      export module supabase {
        export module realtime {
          export class HasRecord {
             ...
             */
            public constructor(implementation: { getRecord(): kotlinx.serialization.json.JsonObject });
            public constructor();
      ...
      export module supabase {
        export module realtime {
          export class PostgresAction {
             ...
             */
            public constructor(implementation: { getColumns(): java.util.List<io.github.jan.supabase.realtime.Column>; getCommitTimestamp(): kotlinx.datetime.Instant });
            public constructor();
      ...
      export module supabase {
        export module realtime {
          export class PresenceAction {
             ...
             */
            public constructor(implementation: { getJoins(): java.util.Map<string, io.github.jan.supabase.realtime.Presence>; getLeaves(): java.util.Map<string, io.github.jan.supabase.realtime.Presence> });
            public constructor();
      ...
      export module supabase {
        export module realtime {
          export class Realtime extends java.lang.Object {
             ...
             */
            public constructor(implementation: { getStatus(): kotlinx.coroutines.flow.StateFlow<io.github.jan.supabase.realtime.Realtime.Status>; getSubscriptions(): java.util.Map<string, io.github.jan.supabase.realtime.RealtimeChannel>; connect(param0: any): any; disconnect(): void; addChannel(param0: io.github.jan.supabase.realtime.Realtime, param1: io.github.jan.supabase.realtime.RealtimeChannel): void; removeChannel(param0: io.github.jan.supabase.realtime.RealtimeChannel, param1: any): any; removeAllChannels(param0: any): any; block(param0: any): any; send(param0: io.github.jan.supabase.realtime.RealtimeMessage, param1: any): any; '<clinit>'(): void });
            public constructor();
            public static API_VERSION: number = 1;
      ...
      export module supabase {
        export module realtime {
          export class RealtimeCallback<T> extends java.lang.Object {
             ...
             */
            public constructor(implementation: { getCallback(): any; getId(): number });
            public constructor();
        ...
        export module realtime {
          export module event {
            export class RealtimeEvent {
               ...
               */
              public constructor(implementation: { handle(param0: io.github.jan.supabase.realtime.RealtimeChannel, param1: io.github.jan.supabase.realtime.RealtimeMessage, param2: any): any; appliesTo(param0: io.github.jan.supabase.realtime.RealtimeMessage): boolean; '<clinit>'(): void });
              public constructor();
              public appliesTo(param0: io.github.jan.supabase.realtime.RealtimeMessage): boolean;
              public handle(param0: io.github.jan.supabase.realtime.RealtimeChannel, param1: io.github.jan.supabase.realtime.RealtimeMessage, param2: any): any;
            }
        ...
        export module realtime {
          export module websocket {
            export class RealtimeWebsocket {
               ...
               */
              public constructor(implementation: { getHasIncomingMessages(): boolean; receive(param0: any): any; send(param0: io.github.jan.supabase.realtime.RealtimeMessage, param1: any): any; blockUntilDisconnect(param0: any): any; disconnect(): void });
              public constructor();
              public disconnect(): void;
              public blockUntilDisconnect(param0: any): any;
              public receive(param0: any): any;
        ...
        export module realtime {
          export module websocket {
            export class RealtimeWebsocketFactory {
               ...
               */
              public constructor(implementation: { create(param0: string, param1: any): any });
              public constructor();
              public create(param0: string, param1: any): any;
            }
          }
      ...
      export module supabase {
        export module storage {
          export class Storage extends java.lang.Object {
             ...
             */
            public constructor(implementation: { createBucket(param0: string, param1: any, param2: any): any; updateBucket(param0: string, param1: any, param2: any): any; retrieveBuckets(param0: any): any; retrieveBucketById(param0: string, param1: any): any; emptyBucket(param0: string, param1: any): any; deleteBucket(param0: string, param1: any): any; get(param0: string): io.github.jan.supabase.storage.BucketApi; from(param0: string): io.github.jan.supabase.storage.BucketApi; '<clinit>'(): void });
            public constructor();
            public static API_VERSION: number = 1;
        ...
        export module storage {
          export module resumable {
            export class ResumableCache {
               ...
               */
              public constructor(implementation: { 'set-zb63x2Q'(param0: string, param1: io.github.jan.supabase.storage.resumable.ResumableCacheEntry, param2: any): any; 'get-iiNwMIM'(param0: string, param1: any): any; 'remove-iiNwMIM'(param0: string, param1: any): any; clear(param0: any): any; entries(param0: any): any });
              public constructor();
              public 'remove-iiNwMIM'(param0: string, param1: any): any;
              public 'set-zb63x2Q'(param0: string, param1: io.github.jan.supabase.storage.resumable.ResumableCacheEntry, param2: any): any;
              public clear(param0: any): any;
        ...
        export module storage {
          export module resumable {
            export class ResumableClient {
               ...
               */
              public constructor(implementation: { createOrContinueUpload(param0: any, param1: string, param2: number, param3: string, param4: any, param5: any): any; createOrContinueUpload(param0: androidNative.Array<number>, param1: string, param2: string, param3: any, param4: any): any; continuePreviousUploads(param0: any, param1: any): any; '<clinit>'(): void });
              public constructor();
        ...
        export module storage {
          export module resumable {
            export class ResumableUpload {
               ...
               */
              public constructor(implementation: { getStateFlow(): kotlinx.coroutines.flow.StateFlow<io.github.jan.supabase.storage.resumable.ResumableUploadState>; 'getFingerprint-h-pxtCA'(): string; pause(param0: any): any; cancel(param0: any): any; startOrResumeUploading(param0: any): any });
              public constructor();
