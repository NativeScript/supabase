...
function parseOptions(options?: FunctionOptions) {
  ...
  let ret: org.nativescript.supabase.SupabaseFunctions.InvokeOptions;

  if (options.body instanceof ArrayBuffer) {
    ret = new org.nativescript.supabase.SupabaseFunctions.InvokeOptions(options.body as never);
  } else if (options.body) {
    ret = new org.nativescript.supabase.SupabaseFunctions.InvokeOptions(JSON.stringify(options.body));
  } else {
    ret = new org.nativescript.supabase.SupabaseFunctions.InvokeOptions();
  }
