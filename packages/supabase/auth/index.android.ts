...
type Client = SupabaseClient & { native: org.nativescript.supabase.SupabaseClient };
...
export class AuthMetaSecurity {
  native_: org.nativescript.supabase.SupabaseAuth.AuthMetaSecurity;
  constructor(captchaToken: string) {
    if ((captchaToken as any) instanceof org.nativescript.supabase.SupabaseAuth.AuthMetaSecurity) {
      this.native_ = captchaToken as never;
    } else {
      this.native_ = new org.nativescript.supabase.SupabaseAuth.AuthMetaSecurity(captchaToken);
    }
  }
  static fromNative(meta: org.nativescript.supabase.SupabaseAuth.AuthMetaSecurity): AuthMetaSecurity {
    if (!meta) return null;
...
export class OpenIDConnectCredentials {
  native_: org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentials;
  constructor(provider: 'google' | 'apple' | 'azure' | 'facebook', idToken: string) {
    let nativeProvider: org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider;
    switch (provider) {
      case 'google':
        nativeProvider = org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.google;
        break;
      case 'apple':
        nativeProvider = org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.apple;
        break;
      case 'azure':
        nativeProvider = org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.azure;
        break;
      case 'facebook':
        nativeProvider = org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.facebook;
        break;
    }
    ...
    this.native_ = new org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentials(nativeProvider, idToken);
  }
  ...
  get provider(): 'google' | 'apple' | 'azure' | 'facebook' {
    switch (this.native.getProvider()) {
      case org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.google:
        return 'google';
      case org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.apple:
        return 'apple';
      case org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.azure:
        return 'azure';
      case org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.facebook:
        return 'facebook';
    }
  }
  ...
  set provider(provider: 'google' | 'apple' | 'azure' | 'facebook') {
    switch (provider) {
      case 'google':
        this.native.setProvider(org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.google);
        break;
      case 'apple':
        this.native.setProvider(org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.apple);
        break;
      case 'azure':
        this.native.setProvider(org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.azure);
        break;
      case 'facebook':
        this.native.setProvider(org.nativescript.supabase.SupabaseAuth.OpenIDConnectCredentialsProvider.facebook);
        break;
    }
  }
}
...
export class Auth {
    ...
    const listener = this.native.addOnAuthStateChange(
      new kotlin.jvm.functions.Function1({
        invoke(event) {
          let eventName;
          switch (event) {
            case org.nativescript.supabase.SupabaseAuth.AuthChangeEvent.initialSession:
              eventName = 'INITIAL_SESSION';
              break;
            case org.nativescript.supabase.SupabaseAuth.AuthChangeEvent.passwordRecovery:
              eventName = 'PASSWORD_RECOVERY';
              break;
            case org.nativescript.supabase.SupabaseAuth.AuthChangeEvent.signedIn:
              eventName = 'SIGNED_IN';
              break;
            case org.nativescript.supabase.SupabaseAuth.AuthChangeEvent.signedOut:
              eventName = 'SIGNED_OUT';
              break;
            case org.nativescript.supabase.SupabaseAuth.AuthChangeEvent.tokenRefreshed:
              eventName = 'TOKEN_REFRESHED';
              break;
            case org.nativescript.supabase.SupabaseAuth.AuthChangeEvent.userUpdated:
              eventName = 'USER_UPDATED';
              break;
            case org.nativescript.supabase.SupabaseAuth.AuthChangeEvent.userDeleted:
              eventName = 'USER_DELETED';
              break;
            case org.nativescript.supabase.SupabaseAuth.AuthChangeEvent.mfaChallengeVerified:
  ...
  signInWithOAuth(credentials: {
    ...
    return new Promise<Session>((resolve, reject) => {
      let nativeProvider: org.nativescript.supabase.SupabaseAuth.Provider;
      switch (credentials.provider) {
        case 'apple':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.apple;
          break;
        case 'azure':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.azure;
          break;
        case 'bitbucket':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.bitbucket;
          break;
        case 'discord':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.discord;
          break;
        case 'facebook':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.facebook;
          break;
        case 'figma':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.figma;
          break;
        case 'github':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.github;
          break;
        case 'gitlab':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.gitlab;
          break;
        case 'google':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.google;
          break;
        case 'kakao':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.kakao;
          break;
        case 'keycloak':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.keycloak;
          break;
        case 'linkedin':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.linkedin;
          break;
        case 'linkedin_oidc':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.linkedinOIDC;
          break;
        case 'notion':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.notion;
          break;
        case 'slack':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.slack;
          break;
        case 'spotify':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.spotify;
          break;
        case 'twitch':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.twitch;
          break;
        case 'twitter':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.twitter;
          break;
        case 'workos':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.workos;
          break;
        case 'zoom':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.zoom;
          break;
        case 'fly':
          nativeProvider = org.nativescript.supabase.SupabaseAuth.Provider.fly;
          break;
      }
      if (!nativeProvider) {
  ...
  signOut(options?: { scope?: 'global' | 'local' | 'others' }): Promise<void> {
    return new Promise((resolve, reject) => {
      let nativeScope: org.nativescript.supabase.SupabaseAuth.SignOutScope;
      switch (options?.scope) {
        case 'global':
          nativeScope = org.nativescript.supabase.SupabaseAuth.SignOutScope.global;
          break;
        case 'local':
          nativeScope = org.nativescript.supabase.SupabaseAuth.SignOutScope.local;
          break;
        case 'others':
          nativeScope = org.nativescript.supabase.SupabaseAuth.SignOutScope.others;
          break;
        default:
          break;
      }
        ...
        if ('phone' in params) {
          if (params.token && params.type) {
            this.native.verifyOTP(
              params.phone,
              params.token,
              params.type === 'sms' ? org.nativescript.supabase.SupabaseAuth.MobileOTPType.sms : org.nativescript.supabase.SupabaseAuth.MobileOTPType.phoneChange,
              params.options?.captchaToken ?? null,
              new kotlin.jvm.functions.Function3({
                invoke(user, session, error) {
                  if (error) {
          ...
          if (params.token && params.type) {
            let nativeType: org.nativescript.supabase.SupabaseAuth.EmailOTPType;
            switch (params.type) {
              case 'email':
                nativeType = org.nativescript.supabase.SupabaseAuth.EmailOTPType.email;
                break;
              case 'signup':
                nativeType = org.nativescript.supabase.SupabaseAuth.EmailOTPType.signup;
                break;
              case 'invite':
                nativeType = org.nativescript.supabase.SupabaseAuth.EmailOTPType.invite;
                break;
              case 'magiclink':
                nativeType = org.nativescript.supabase.SupabaseAuth.EmailOTPType.magiclink;
                break;
              case 'recovery':
                nativeType = org.nativescript.supabase.SupabaseAuth.EmailOTPType.recovery;
                break;
              case 'email_change':
                nativeType = org.nativescript.supabase.SupabaseAuth.EmailOTPType.emailChange;
                break;
            }
            if (!nativeType) {
  ...
  update(attributes: {
    ...
    return new Promise<User>((resolve, reject) => {
      const attr = new org.nativescript.supabase.SupabaseAuth.UserAttributes();
      if (attributes.data) {
  ...
  resend(credentials: {
    ...
    return new Promise<void>((resolve, reject) => {
      if ((credentials.email && credentials.type === 'signup') || credentials.type === 'email_change') {
        this.native.resend(
          credentials.email,
          credentials.type === 'signup' ? org.nativescript.supabase.SupabaseAuth.ResendEmailType.signup : org.nativescript.supabase.SupabaseAuth.ResendEmailType.emailChange,
          credentials?.options?.emailRedirectTo ?? null,
          credentials?.options?.captchaToken ?? null,
          new kotlin.jvm.functions.Function1({
            invoke(error) {
        ...
        this.native.resend(
          credentials.phone,
          credentials.type === 'sms' ? org.nativescript.supabase.SupabaseAuth.ResendMobileType.sms : org.nativescript.supabase.SupabaseAuth.ResendMobileType.phoneChange,
          credentials?.options?.captchaToken ?? null,
          new kotlin.jvm.functions.Function1({
            invoke(error) {
              if (error) {
