...
function parseTransformOptions(options?: TransformOptions) {
  const ret = new org.nativescript.supabase.SupabseStorage.FileApi.TransformOptions();
  if (options) {
...
function parseSearch(options?: SearchOptions) {
  ...
  const ret = new org.nativescript.supabase.SupabseStorage.FileApi.SearchOptions();
  if ('limit' in options) {
  ...
  if ('sortBy' in options) {
    if ('column' in options.sortBy || 'order' in options.sortBy) {
      const sort = new org.nativescript.supabase.SupabseStorage.FileApi.SortBy();
...
function parseFileOptions(options?: FileOptions) {
  ...
  const ret = new org.nativescript.supabase.SupabseStorage.FileApi.FileOptions();
...
export class StorageFileApi {
  native_: org.nativescript.supabase.SupabseStorage.FileApi;
  static fromNative(value: org.nativescript.supabase.SupabseStorage.FileApi): StorageFileApi {
    if (!value) return null;
...
export class SupabaseStorageClient {
  ...
  createBucket(id: string, options?: BucketOptions) {
    return new Promise<void>((resolve, reject) => {
      let opt: org.nativescript.supabase.SupabseStorage.BucketOptions | null = null;
      if (options) {
        opt = new org.nativescript.supabase.SupabseStorage.BucketOptions();
