 ...
 */
export const convertChangeData = (columns: Columns, record: Record, options: { skipTypes?: string[] } = {}): Record => {
 ...
 * //=> "33"
 */
export const convertColumn = (columnName: string, columns: Columns, record: Record, skipTypes: string[]): RecordValue => {
